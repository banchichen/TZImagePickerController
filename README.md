# TZImagePickerController
 ...
 tip: 发布后不久，陆陆续续发现一些bug，表示抱歉...目前版本已到1.0.7，修复了从发布到现在发现的一些bug。如果你发现了bug，请先拉一下最新的代码，如果bug还在请提一个issue。从目前的情况看，已经发现的bug都解决了，现在的表现还算较好~
...
## 一. Installation 安装
  ...
  * CocoaPods：pod 'TZImagePickerController', '~> 1.0.7'
