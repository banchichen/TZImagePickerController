...
- (void)configCustomNaviBar {
    ...
    [_backButton setImage:[UIImage imageNamedWithMyBundle:@"navi_back"] forState:UIControlStateNormal];
    [_backButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_backButton addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
    
    _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.tz_width - 54, 10, 42, 42)];
    [_selectButton setImage:[UIImage imageNamedWithMyBundle:@"photo_def_photoPickerVc"] forState:UIControlStateNormal];
    [_selectButton setImage:[UIImage imageNamedWithMyBundle:@"photo_sel_photoPickerVc"] forState:UIControlStateSelected];
...
- (void)configBottomToolBar {
    ...
    if (imagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[UIImage imageNamedWithMyBundle:@"preview_original_def"] forState:UIControlStateNormal];
