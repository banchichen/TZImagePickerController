...
- (void)viewDidLoad {
    ...
    if (imagePickerVc.navRightBarButtonSettingBlock)
    {
        ...
        [rightButton setTitleColor:imagePickerVc.barItemTextColor forState:UIControlStateNormal];
        imagePickerVc.navRightBarButtonSettingBlock(rightButton);
